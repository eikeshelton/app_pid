...
4. **Configure o banco de dados Substitua user, password e dbname pelas suas credenciais do PostgreSQL no arquivo app.py:**

      ```bash
      DATABASE_URL = "postgresql://user:password@localhost/dbname"

5. **Inicie o servidor Inicie o servidor FastAPI com o seguinte comando**
